 ...
 */
final class Version20240704004933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scolarites1 ADD niveau_id INT NOT NULL, ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD scolarite INT NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE scolarites2 ADD scolarite1_id INT NOT NULL, ADD niveau_id INT NOT NULL, ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD scolarite INT NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE scolarites3 ADD niveau_id INT NOT NULL, ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD scolarite INT NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE scolarites3 ADD CONSTRAINT FK_DC834A68B3E9C81 FOREIGN KEY (niveau_id) REFERENCES niveaux (id)');
        $this->addSql('ALTER TABLE scolarites3 ADD CONSTRAINT FK_DC834A68B03A8386 FOREIGN KEY (created_by_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE scolarites3 ADD CONSTRAINT FK_DC834A68896DBBDE FOREIGN KEY (updated_by_id) REFERENCES users (id)');
        $this->addSql('CREATE INDEX IDX_DC834A68B3E9C81 ON scolarites3 (niveau_id)');
        $this->addSql('CREATE INDEX IDX_DC834A68B03A8386 ON scolarites3 (created_by_id)');
        $this->addSql('CREATE INDEX IDX_DC834A68896DBBDE ON scolarites3 (updated_by_id)');
        ...
        $this->addSql('ALTER TABLE users ADD nom_id INT NOT NULL, ADD prenom_id INT NOT NULL, ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD email VARCHAR(255) NOT NULL, ADD adresse VARCHAR(15) DEFAULT NULL, ADD fullname VARCHAR(255) NOT NULL, ADD reset_token VARCHAR(100) DEFAULT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD slug VARCHAR(128) NOT NULL');
        ...
        $this->addSql('ALTER TABLE users RENAME INDEX uniq_identifier_username TO UNIQ_1483A5E9F85E0677');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scolarites3 DROP FOREIGN KEY FK_DC834A68B03A8386');
        $this->addSql('ALTER TABLE scolarites3 DROP FOREIGN KEY FK_DC834A68896DBBDE');
        $this->addSql('DROP INDEX IDX_DC834A68B3E9C81 ON scolarites3');
        $this->addSql('DROP INDEX IDX_DC834A68B03A8386 ON scolarites3');
        $this->addSql('DROP INDEX IDX_DC834A68896DBBDE ON scolarites3');
        $this->addSql('ALTER TABLE scolarites3 DROP niveau_id, DROP created_by_id, DROP updated_by_id, DROP scolarite, DROP created_at, DROP updated_at');
        ...
        $this->addSql('ALTER TABLE users DROP nom_id, DROP prenom_id, DROP created_by_id, DROP updated_by_id, DROP email, DROP adresse, DROP fullname, DROP reset_token, DROP created_at, DROP updated_at, DROP slug');
        $this->addSql('ALTER TABLE users RENAME INDEX uniq_1483a5e9f85e0677 TO UNIQ_IDENTIFIER_USERNAME');
        ...
        $this->addSql('ALTER TABLE scolarites1 DROP niveau_id, DROP created_by_id, DROP updated_by_id, DROP scolarite, DROP created_at, DROP updated_at');
        ...
        $this->addSql('ALTER TABLE scolarites2 DROP scolarite1_id, DROP niveau_id, DROP created_by_id, DROP updated_by_id, DROP scolarite, DROP created_at, DROP updated_at');
    }
}
